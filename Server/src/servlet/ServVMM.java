...
import main.VirtualMachineManage;
 ...
 */
@WebServlet(description = "Rest server for asws service", urlPatterns = { "/servlet/ServVMM" })
public class ServVMM extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\ASWS\\asws_log.properties";
	Logger logger = Logger.getLogger(ServVMM.class.getName());
	VirtualMachineManage api = new VirtualMachineManage();
