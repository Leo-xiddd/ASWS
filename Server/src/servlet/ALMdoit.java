 ...
 */
@WebServlet(description = "Rest server for asws service", urlPatterns = { "/servlet/ALMdoit" })
public class ALMdoit extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\ASWS\\asws_log.properties";
	Logger logger = Logger.getLogger(ALMdoit.class.getName());
	ALM api = new ALM();
