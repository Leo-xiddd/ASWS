 ...
 */
@WebServlet(description = "Rest server for asws service", urlPatterns = { "/servlet/ServTEM" })
public class ServTEM extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\ASWS\\asws_log.properties";
	Logger logger = Logger.getLogger(ServTEM.class.getName());
	TestExecManage api = new TestExecManage();
