 ...
 */
@WebServlet(description = "Rest server for asws service", urlPatterns = { "/servlet/ServPM" })
public class ServPM extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\ASWS\\asws_log.properties";
	Logger logger = Logger.getLogger(ServPM.class.getName());
	ProjectManage api = new ProjectManage();
