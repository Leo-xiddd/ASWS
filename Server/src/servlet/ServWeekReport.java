 ...
 */
@WebServlet(description = "Rest server for asws service", urlPatterns = { "/servlet/ServWeekReport" })
public class ServWeekReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String logconf=System.getProperty("user.dir").replace("\\bin", "")+"\\conf\\ASWS\\asws_log.properties";
	Logger logger = Logger.getLogger(ServWeekReport.class.getName());
	WeekReport api = new WeekReport();
	
    public ServWeekReport() {
        super();
    }
